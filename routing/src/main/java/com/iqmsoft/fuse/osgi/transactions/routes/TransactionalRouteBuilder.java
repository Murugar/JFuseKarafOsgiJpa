 ...
 */
package com.iqmsoft.fuse.osgi.transactions.routes;

import static com.iqmsoft.fuse.osgi.transactions.routes.Airports.randomAirport;

import org.apache.camel.Exchange;
import org.apache.camel.Processor;
import org.apache.camel.spring.SpringRouteBuilder;
import com.iqmsoft.fuse.osgi.transactions.model.Flight;
...
public class TransactionalRouteBuilder extends SpringRouteBuilder {
    ...
    public void configure() throws Exception {
        from("amq://Input.Flights?username=admin&password=admin")
                ...
                .to("jpa://com.iqmsoft.fuse.osgi.transactions.model.Flight");
    }
